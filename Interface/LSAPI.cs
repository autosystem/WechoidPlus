   ...
   public class LSAPI
    {
       ...
       [DllImport("lsapiw32.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
       ...
       [DllImport("lsapiw32.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
       public static extern uint VLSdeleteFeatureExt(string feature_name, string version, [MarshalAs(UnmanagedType.LPStr)] object capacity, string log_comment, ref CHALLENGE challenge, string unused1, ref uint unused2);
       [DllImport("lsapiw32.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
       ...
       [DllImport("lsapiw32.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
       public static extern uint VLSdeleteLicenseFromFileExt(string feature_name, string version, [MarshalAs(UnmanagedType.LPStr)] object puiCapacity, string license_hash, int license_hash_len, StringBuilder license_string, ref int license_string_bufsize, ref int unused1, int unused2);
       [DllImport("lsapiw32.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
       ...
       [DllImport("lsapiw32.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
       public static extern uint VLSgetFeatureInfoExt(string feature_name, string version, [MarshalAs(UnmanagedType.LPStr)] object capacity, int index, string unused1, ref uint unused2, ref VLSFeatureInfo feature_info);
       [DllImport("lsapiw32.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
       ...
       [DllImport("lsapiw32.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
       public static extern uint VLSgetLicenseInfoExt(string feature_name, string version, [MarshalAs(UnmanagedType.LPStr)] object capacity, int feature_index, string license_hash, int license_hash_len, int license_index, ref VLSlicenseInfo licenseInfo);
       [DllImport("lsapiw32.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
